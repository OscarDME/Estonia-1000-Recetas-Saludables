...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 Tervislikku retsepti 2.0",
    description:
  ...
  faq: {
    authorRole: "Esencia Pro · Tervisliku toitumise meeskond",
    authorHeadline: "Maitsev toit, mis hoolitseb sinu tervise eest",
    authorBio:
      "Esencia Pros usume, et diabeet ei tohi sinult võtta toidust saadavat naudingut. Iga retsept on loodud nii, et saaksid süüa ilma süümepiinadeta ja hoida oma glükoosi täieliku kontrolli all.",
    authorImageAlt: "Esencia Pro meeskond",
